...
import styles from "./innerComponentsStyles/CarsListPageInput.module.css";

const CarsListPageInput = ({onClick,selectedValue,title}) => {
  return (
    <>
      <Box
        className={styles["toolsbar__filter-input-container"]}
        onClick={() => onClick()}
      >
        <Button
          disableRipple
          sx={{ all: "unset" }}
          className={styles["filter-input-text"]}
        >
          {selectedValue || title}
        </Button>
      </Box>
...
export default CarsListPageInput;
